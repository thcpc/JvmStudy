...
public class RuntimeVisibleTypeAnnotations extends ByteCode<Map<String, ByteCode>> {
    public final static String NAME = "RuntimeVisibleTypeAnnotations";
    ...
    public RuntimeVisibleTypeAnnotations(Map<String, ByteCode> value) {
        super(value);
    }
}