...
public class RuntimeInvisibleAnnotations extends ByteCode<Map<String, ByteCode>> {
    public final static String NAME = "RuntimeInvisibleAnnotations";
    ...
    public RuntimeInvisibleAnnotations(Map<String, ByteCode> value) {
        super(value);
    }
}