...
public class RuntimeVisibleParameterAnnotations extends ByteCode<Map<String, ByteCode>> {
    public final static String NAME = "RuntimeVisibleParameterAnnotations";
    ...
    public RuntimeVisibleParameterAnnotations(Map<String, ByteCode> value) {
        super(value);
    }
}